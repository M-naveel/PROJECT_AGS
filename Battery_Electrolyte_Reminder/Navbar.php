...
<div class="row">
<nav class="navbar navbar-expand-lg navbar-lightrk bg-da text-white custom-header px-3 fixed-top">
...
<div class="dropdown  d-inline">
    <button class="btn custom-header dropdown-toggle" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
